...
import adminPhoto from '../../assets/images/jn.png';
      ...
      <div className='flex items-center justify-between'>
        ...
        dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors'
          ...
          <div className='hidden md:block'>
            <h1 className='text-2xl font-black text-[#1a3ac8] dark:text-white text-shadow-lg text-shadow-[#a8aab3]'>
              Dashboard
            </h1>
            <p className='text-md text-shadow-lg text-[#1a3ac8] text-shadow[#1a3ac8]'>
              Welcome back, Julian ! Here is what is happening today.
            </p>
          </div>
        </div>
        ...
        <div className='flex items-center space-x-3'>
          {/* Quick Action */}
          <button
            className='hidden lg:flex items-center space-x-2 py-2 px-4 bg-linear-to-r from-[#1562df] to-[#eb06f3]
          ...
          {/* Toggle */}
          <button
            className='p-2.5 rounded-xl text-slate-600 dark:text-slate-300 hover:bg-slate-300
          ...
          {/* Notifications */}
          <button
            className='relative p-2.5 rounded-xl text-slate-600 dark:text-slate-300 hover:bg-slate-300
            dark:hover:bg-slate-800 transition-colors'
          >
